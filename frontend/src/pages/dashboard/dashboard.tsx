              ...
              <div className="mb-10 flex flex-col gap-4">
                ...
                <div className="flex flex-wrap gap-8 ">
                  <div className="flex gap-2 items-center">
                    <span className="font-semibold capitalize">cashin</span>
                    <IoIosArrowForward />
                    <span className="text-sm text-gray-600">
                      R${" "}
                      {isHidden
                        ? "****"
                        : formatarNumeroParaBRL(data?.total.cashin || 0)}
                    </span>
                  </div>
                  <div className="flex gap-2 items-center">
                    <span className="font-semibold capitalize">cashout</span>
                    <IoIosArrowForward />
                    <span className="text-sm text-gray-600">
                      R${" "}
                      {isHidden
                        ? "****"
                        : formatarNumeroParaBRL(data?.total.cashout || 0)}
                    </span>
                  </div>
                  {/* <div className="flex gap-2 items-center">
                      ...
                      <div className="flex justify-center gap-3 w-full mb-5">
                        <div className="flex flex-col w-full px-3 py-4 rounded-lg bg-[var(--background-secound-color)]">
                          ...
                          <span className="text-white text-[19px] font-semibold">
                            ...
                            {isHidden
                              ? "****"
                              : formatarNumeroParaBRL(data?.tpv.mes_atual || 0)}
                          </span>
                        </div>
                            ...
                            <LineChart
                              ...
                              data={
                                isHidden
                                  ...
                                  : data?.cashin.relatorio_ultimo_ano
                              }
                              margin={{
                                top: 5,
                                right: 5,
                        ...
                        <div className="flex justify-center gap-3 w-full mb-5">
                          <div className="flex flex-col w-full px-3 py-4 rounded-lg bg-[var(--background-secound-color)]">
                            ...
                            <span className="text-white text-[19px] font-semibold">
                              {isHidden
                                ? "****"
                                : data?.quantidade_de_transacoes.mes_atual || 0}
                            </span>
                          </div>
                          <div className="flex flex-col w-full px-3 py-4 rounded-lg border border-gray-200">
                            <span className="text-[var(--background-secound-color)] text-[17px] font-semibold">
                            ...
                            <span className="text-[var(--background-secound-color)] text-[19px] font-semibold">
                              {isHidden
                                ? "****"
                                : data?.quantidade_de_transacoes.mes_anterior ||
                                  0}
                            </span>
                          </div>
                        </div>
