          ...
          <dialog className="z-20 bg-[var(--background-secound-color)] backdrop-blur-xl flex justify-center items-center lg:bg-transparent h-full w-full absolute py-20 top-0 overflow-y-auto">
            <div className="flex flex-col max-w-4xl   items-center justify-center bg-[var(--background-secound-color)] lg:border-2 border-[var(--border-color2)]  max-[1000px]:border">
              <div className="flex w-full text-[var(--title-primary-color)] items-center justify-between px-4 py-6 border-b border-[var(--border-color2)] ">
                <span className="text-[18px] font-semibold">Conta criada</span>
              </div>
              ...
              <div className="w-full flex flex-col items-center ">
                <div className="w-[90%] flex flex-col py-4 gap-4 border-b-2 border-[var(--border-color)] ">
                  ...
                  <span className="text-[15px] text-[var(--title-primary-color)]">
                    Sua senha de acesso foi enviada para o email {request.email}
                  </span>
              ...
              <div className=" h-full  w-full flex flex-col items-center">
                <form
                  ...
                  onSubmit={(e) => {
                    ...
                    axios
                      .post("https://api.binbank.com.br/subcontas/criar", {
                        user: request.user,
                        name: request.nome,
                        email: request.email,
                        cpfCnpj: request.cpfCnpj,
                        taxas_representante: request.taxas_representante,
                      })
                      .then(() => {
                        toast.success("Conta Solicitada com sucesso!");
                        setModalConfirm(true);
                      ...
                      .catch((err) => {
                        ...
                        if (
                          ...
                          return toast.warn("Usuario sem permissão");
                        if (err.response.status === 409)
                          return toast.warn("Conta já cadastrado");
                        toast.error(
                          err.response.erro || "Erro ao cadastrar Conta"
                        );
                      })
                      .finally(() => {
                        setIsLoading(false);
                ...
                >
                  ...
                  <div className="flex px-[5%] flex-col items-center text-[var(--title-primary-color)]   w-full ">
                    <div className="flex mb-5 justify-center">
                      <span className="text-sm font-medium  mr-3">PF</span>
                      <label className="relative inline-flex  cursor-pointer">
                        ...
                        <span className="ms-3 text-sm font-medium ">PJ</span>
                      </label>
                    </div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(x) => {
                            ...
                            if (!isChecked && cnpjOrcpf.length < 11) return;
                            if (isChecked && cnpjOrcpf.length < 14) return;
                            ...
                            if (!isValid) {
                              toast.warn(
                                `${isChecked ? "CNPJ" : "CPF"} Invalido`
                              );
                            } else {
                              toast.success(
                                `${isChecked ? "CNPJ" : "CPF"} valido`
                              );
                            }
                          }}
                          onInput={(e) => {
                          ...
                          placeholder={
                            isChecked ? "00.000.000/0000-00" : "000.000.000-00"
                          }
                          required
                        />
                      </div>
                  ...
                  <div className="px-[5%] flex flex-col items-center    py-8 mx-auto  max-[1000px]:py-0  lg:py-0 w-full ">
                    ...
                    >
                      {isLoading ? "Carregando..." : "Solicitar abertura"}
                    </button>
                  </div>
                </form>
              </div>
