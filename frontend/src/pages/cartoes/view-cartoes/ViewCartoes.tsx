                        ...
                        <ul className="flex gap-3 flex-col">
                              ...
                              <span className="flex flex-col gap-2">
                                 <p>
                                    <b className="text-gray-900">
                                       Como Funciona o Nosso Cartão de Crédito
                                       Vinculado a Investimentos
                                    </b>
                                 </p>

                                 <p className="text-gray-700 ml-5">
                                    Nosso cartão de crédito oferece uma maneira
                                    inovadora de gerenciar suas finanças,
                                    combinando o uso de crédito com um
                           ...
                           <li>
                              <span className="flex flex-col gap-2">
                                 ...
                                 <p className="text-gray-700 ml-5">
                                    Para começar a usar o cartão de crédito, é
                                    necessário fazer um{" "}
                                    <NavLink
                                       to="/investimentos"
                                    ...
                                    automaticamente convertido em saldo no seu
                                    cartão de crédito.{" "}
                                 </p>
                              </span>
                           </li>
                           <li>
                              <span className="flex flex-col gap-2">
                                 ...
                                 <p className="text-gray-700 ml-5">
                                    O valor que você investe se torna seu limite
                                    de crédito. Por exemplo, se você investir R$
                                    1.500, esse será o saldo disponível no seu
                                    cartão.
                                 </p>
                              </span>
                           </li>
                           <li>
                              <span className="flex flex-col gap-2">
                                 ...
                                 <p className="text-gray-700 ml-5">
                                    O investimento possui um prazo de 720 dias
                                    (cerca de 2 anos). Durante esse período,
                                    você poderá utilizar o limite do cartão
                                    normalmente, com a segurança de que seu
                           ...
                           <li>
                              <span className="flex flex-col gap-2">
                                 ...
                                 <p className="text-gray-700 ml-5">
                                    Ao final dos 720 dias, o valor investido é
                                    resgatado e retorna para a sua conta.
                                    Consequentemente, o saldo retirado do
                                    investimento será descontado do limite
