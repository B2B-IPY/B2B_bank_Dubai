...
function ListCard() {
   ...
   useEffect(() => {
      ...
      axios
         .post("https://api.noutbank.com.br/cartoes", {}, headers)
         .then((res) => {
      ...
      axios
         .post("https://api.noutbank.com.br/clientes", {}, headers)
         .then((res) => {
            const data = res.data;
            setClienteList(data);
         });
   ...
   function filtrar() {
      ...
      axios
         .post(
            "https://api.noutbank.com.br/cartoes",
            {
               numero: $("#search").val(),
            },
            headers
   ...
   function criarCartao() {
      ...
      axios
         .post("https://api.noutbank.com.br/cartoes/criar", cardInfo, headers)
         .then(() => {
