          ...
          <div className="grid grid-cols-2 bg-[var(--background-secound-color)] rounded-lg divide-x py-5 px-5">
            <div className="">
              ...
              <div className="flex flex-col">
                <span className="text-[var(--title-primary-color)]">Fixo</span>
                        ...
                        onChange={(e) => {
                          ...
                          setTaxasRepresentante((prev) => {
                            return [
                              ...prev,
                              {
                                uuid: parseInt(gerarNumeroAleatorio()),
                                id: id,
                                user: user,
                                user_id: id.toString(),
                                taxas: taxas,
                          ...
                          return (
                            <div
                              onClick={() => {
                                setTaxasRepresentante((prev) => {
                                  return prev.filter(
                                    (item) => item.uuid !== representante.uuid
                                  );
                                });
                              }}
                              key={i}
                                        ...
                                        <div className="flex gap-3">
                                          ...
                                          <div className="bg-transparent border border-gray-300 text-[var(--title-primary-color)] sm:text-sm rounded-lg focus:ring-[var(--primary-color)] focus:border-[var(--primary-color)] flex justify-between w-full p-2.5 max-[1000px]:bg-transparent  max-[1000px]:focus:outline-none max-[1000px]:focus:ring-1 max-[1000px]:focus:border-[var(--primary-color)] gap-2">
                                            <input
                                              type="text"
                                              defaultValue={
                                                representante.taxas.bank.cashin
                                                  .porcentagem
                                              }
                                              onInput={(e) => {
                                                const value =
