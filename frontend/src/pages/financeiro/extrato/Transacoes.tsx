...
function Transacoes() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://api.binbank.com.br/extrato/${page}`, headers)
      .then(({ data }) => {
        console.log(data);
        setData(data);
      })
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex w-[340px] gap-3 items-center max-[950px]:hidden">
                          <span className="">
                            {obj.data.name ? obj.data.name : "Transação "}
                          </span>
                        </div>
                        ...
                        <span>
                          {isHidden
                            ? "R$ ********"
                            : `R$ ${parseFloat(obj.data.amount).toFixed(2)}`}
                        </span>
                      </div>
                    );
                  })}
