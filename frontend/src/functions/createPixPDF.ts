...
export function ComprovantePix(
  ...
  doc.addImage(logo, "PNG", 69, 15, 50, 20, "imglogo");
  ...
  doc.setTextColor("#000");
  doc.setFontSize(12);
  doc.text(nomeDestinatario + " - " + cpfcnpj, 185, 69, {
    align: "right",
  });

  doc.setFontSize(12);
  doc.text("Ispb:" + " " + banco, 185, 76, { align: "right" });

  doc.setFontSize(12);
  doc.text("Chave: " + key, 185, 83, { align: "right" });
