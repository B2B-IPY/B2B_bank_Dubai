...
export const criarSubContaZod = z.object({
  ...
  cashin_fixo: z.number({ message: "cashin_fixo inválido" }),
  cashin_porcent: z.number({ message: "cashin_porcent inválido" }),
  cashout_fixo: z.number({ message: "cashout_fixo inválido" }),
  cashout_porcent: z.number({ message: "cashout_porcent inválido" }),
});
